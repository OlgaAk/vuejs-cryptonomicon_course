...
export default {
  ...
  methods: {
    ...
    subscribeToUpdates(tickerName) {
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=5a60f810835f700f1a36a9f84995a4278bb5e88d83fa813b5ca81777eebff104`
        );
    ...
    normalizeGraph() {
      ...
      console.log(((minValue - minValue) * 100) / (maxValue - minValue));
